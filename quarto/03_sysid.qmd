...
Non-linear SISO system. Input: upper tank inlet flow $u$. Output: lower tank level $y=x_2$. 
...
## Pre-processing
Deep learning algorithms perform better with favorable **scaling** (e.g., standardization)
```{python}
...
:::{.fragment}
W2 and b2 scaled down to prevent state from exploding - initializations are important!
:::
...
\pause
\vskip 1em
* For large dataset, you'd slice the data into smaller chunks and do mini-batching...
...
* Try out a different dataset 
  * Your own dataset, or some other public [benchmark](https://www.nonlinearbenchmark.org/benchmarks)
...
## Remarks
* Training feedforward and recurrent neural networks in JAX is relatively easy
\vskip 1em
...
## EECI Course M14 Deep Learning for System Identification
An extended course on **June 15--June 19 in Leuven** (BE). Additional topics:

* Custom architectures based on physics and system theory
* Optimization details: mini-batching, non-smooth, constrained…
* Automatic differentiation details
* Transformers \& meta learning
* PyTorch implementation

\begin{center}
\includegraphics[height=9em]{img/qr.png} \\
